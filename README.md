# AUGMANITAI Periodic Table

Interactive periodic table of 100 core AUGMANITAI terms for human-AI interaction. Excerpt from the 1000-term compendium. CC BY-NC-ND 4.0.

**Live:** https://periodic.augmanitai.com/

## Features

- Element-card grid with category coloring
- Keyboard-grid-navigation (Arrow keys ±1/±10, Home/End)
- Full-text search (press / to focus)
- Hover tooltip with quick definition
- Modal detail view with share intents (X/LinkedIn/Email)
...
1. Push this folder to `https://github.com/<YOUR-GH-USER>/augmanitai-periodic-table`.
2. Enable GitHub Pages: Settings -> Pages -> Source: main -> root -> Save.
3. DNS: point `CNAME periodic.augmanitai.com` to `<YOUR-GH-USER>.github.io`.
